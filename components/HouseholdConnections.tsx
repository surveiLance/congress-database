    ...
    <section className="household-section" aria-labelledby="household-connections-title">
      <div className="household-section-heading">
        <div>
          ...
          <p>Suggestions prioritize matching surname and middle-name patterns or names explicitly listed by the family. A surname alone is not enough; address and contact details only strengthen a name match.</p>
        </div>
